        ...
        >
          ...
          <div className="flex flex-wrap gap-4 mb-10">
            ...
            >
              ...
              <button className="bg-cyan-500 hover:bg-cyan-600 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 shadow-lg hover:scale-105">
            ...
            {/* Event Brochure */}
            <a
              href="/brochures/event-brochure.pdf"
              download
            >
